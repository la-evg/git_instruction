...
- Для предложения изменения чужого удаленного репозитория используется комманда `pull request`.
    
    Для этого необходимо:
    1. Создать ответвление репозитория с помощью кнопки `fork`
        ![fork](img/git_fork.png "fork")
    2. Склонировать свой созданный репозиторий
        ![clone](img/git_clone.png "clone")
    3. Создаем новую ветку и в нее внести изменения/дополнения
        ![clone](img/git_clone.png "clone")
    4. Зафиксировать изменения
    5. Выгрузить свой локальный репозиторий в удаленный
    6. На сайте GitHub нажимть кнопку `pull request`